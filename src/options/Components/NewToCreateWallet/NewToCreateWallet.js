  ...
  return (
    <div>
      <div className="Create-wallet-container">
        <div>
          <span className="questionIcon" onClick={openModal}>
            <FontAwesomeIcon
            ...
            <div id="createModal">
              ...
              <div className="mb-4">
                ...
                <div className="howMetaMask-walletWork-videoContainer mb-2">
                  ...
                  >
                    <source type="video/webm" src={video9} />
                  </video>
                </div>
                <div>
                  <div className="howMetaMask-walletWork-videoContainer-list">
                    ...
                    <div>
                      <p>
                        MetaMask is a decentralized wallet that stores different
                        assets on the Ethereum blockchain. This includes coins,
                        tokens, and NFTs
                      </p>
                    </div>
                  </div>
                  <div className="howMetaMask-walletWork-videoContainer-list">
                    ...
                    <div>
                      <p>
                        With MetaMask, you can access other decentralized
                        applications on the Web3.0 through your browser.
                      </p>
                    </div>
                  </div>
                  <div className="howMetaMask-walletWork-videoContainer-list">
                    ...
                    <div>
                      <p>
                        {" "}
                        MetaMask generates passwords and keys on your device, so
                        only you have access to your accounts and data. You
                        always choose what to share and what to keep private.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div>
          <button
            onClick={() => goTo(CreateHelpImproveWallet)}
            id="createWalletBtn"
          >
            Create Wallet
          </button>
