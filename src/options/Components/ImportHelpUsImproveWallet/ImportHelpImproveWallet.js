    ...
    <>
      ...
      >
        ...
        <div className="helpUsImproveWallet-container">
          ...
          <div className="improve-help-text">
            ...
            <p role="text">
              <FontAwesomeIcon
                ...
                className="checkIcon"
              />{" "}
              Always allow you to opt-out via Settings. <br />
          ...
          <button onClick={() => goTo(ImportWallet)} id="noThanksBtn" type="">
            No Thanks
          </button>
          <button onClick={() => goTo(ImportWallet)} id="agreeBtn" type="">
            I Agree
          </button>
