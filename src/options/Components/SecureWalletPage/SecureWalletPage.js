          ...
          <div className="col-md-8">
            <div className="secure-container">
              <div className="secure-header-text">
                ...
                <p>
                  Before getting started, watch this short video to learn about
                  your recovery phrase and how to keep your wallet safe.
                </p>
              </div>
              <div className="secure-video-container">
                <video
                  aria-label="Video - How you can recover your prase and how to keep your wallet safe"
                  controls
                  style={{
                    borderRadius: "5px",
                    width: "auto",
                ...
                >
                  <source type="video/webm" src={video5} />
                </video>
              </div>
              <button
                onClick={() => goTo(SecretBackupPhrase)}
                id="NextBtn"
                type=""
              >
                Next
          ...
          <div className="col-md-4">
            <SelfFocus>
              <div className="secureTips-text-container">
                ...
                <p>
                  Your recovery phrase is the "master key" to your wallet and
                  funds.
                </p>
                ...
                <p>
                  If someone asks for your recovery phrase, they are most likely
                  trying to scam you.
                </p>
              </div>
            </SelfFocus>
