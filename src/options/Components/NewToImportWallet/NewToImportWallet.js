  ...
  return (
    <div>
      <div className="import-wallet-container">
          ...
          >
            <div className="importModal">
              ...
              <div className="mt-5 mb-5">
                <h5 className="text-center mt-5 mb-5" tabIndex="0">
                  How does importing a MetaMask wallet works
                </h5>
                <ol tabIndex="0" >
                  <li>
                    If you have an existing account where you backed up your{" "}
                    <a href="">seedphrase</a>, simply input the seedphrase to
                    access the account.
                  </li>
                  <li>
                    Create a new password for the MetaMask extension on your
                    computer that is secure.
                  </li>
                  <li>
                    {" "}
                    That's it! You're setup on MetaMask and now have access to
                    the account your imported.
                  </li>
                </ol>
              </div>
            </div>
        ...
        <div>
          <button
            onClick={() => goTo(ImportHelpImproveWallet)}
            id="importWalletBtn"
          >
            Import Wallet
          </button>
