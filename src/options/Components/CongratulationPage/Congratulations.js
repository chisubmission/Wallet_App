...
const Congratulations = () => {
  const congrats = useRef();

  useEffect(() => {
    if (congrats.current) congrats.current.focus();
  }, []);
  return (
    <>
      <div
      ...
      >
        ...
        <div className="congratulation-text-container">
          <div className="congratulation-title">
            <h1 ref={congrats} tabIndex="0">Congratulations</h1>
            <p>
          ...
          <div className="congratulation-text">
            ...
            <ul>
              ...
              <li>
                If you need to backup your secret recovery phrase again, you can
                find it in Settings - Security.
              </li>
              <li>
                If you ever have questions or see something fishy, contact our
                support <a href="">here</a>
              </li>
            </ul>

            <p>
              *MetaMask can not recover your secret recovery phrase.{" "}
              <a href="">Learn more</a>
            </p>
          </div>
          <button onClick={() => goTo(Home)} id="allDoneBtn" type="">
            All Done
          </button>
        </div>
      </div>
