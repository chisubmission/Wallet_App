            ...
            <div className="col-sm-7">
              <div className="secret-backup-phrase-container">
                ...
                <div className="secret-backup-header-text">
                  <h1>Secret Backup <br/> Phrase</h1>
                  <p>Your secret backup phrase makes it easy to <br/> backup and restore your account.</p>
                </div>

                <div className="secret-warning">
                  <p><span>WARNING:</span> Never disclose your backup phrase. Anyone with this phrase can take <br/> your assets forever.</p>
                </div>

                <div className="download-encrypted-container mt-2">
