...
const Send = () => {
  ...
  // Function for slect eth balance number handler and set state 
        ...
        <div className="ethereum-gas-container">
          <div class="row">
            <div className="col-sm-6">
              ...
              <video controls style={{ borderRadius: '5px', width: 'auto', height: '160px', boxShadow: 'rgba(0, 0, 0, 0.16) 0px 1px 4px'}}>
                <source
                  type="video/webm"
                  src={video7}
                />
