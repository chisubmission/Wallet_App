    ...
    <div>
      <div className="home-body">
        <div className="home-header">
          <div className="container-fluid" style={{width: "750px", margin: "auto"}}>
          ...
          <div className="home-container">
            ...
            <div className="balance-container m-auto">
              ...
              <div className="eth-balance text-center">
                <h3>
                  <span className='ethBalance1'>7</span> ETH
                </h3>
                <p>$ 
                 <span className='usdBalance1'>20145</span> USD</p>
              </div>
              ...
              <div className="assets-balance-container d-flex">
                <div className="d-flex">
                  ...
                  <div className="assets-eth-balance">
                    <h6>
                      <span className='ethBalance2'>7</span> ETH
                    </h6>
                    <p>$ 
            ...
            {/* <div className="add-token-container">
              <div className="add-token d-flex justify-content-center mb-5 mt-4">
